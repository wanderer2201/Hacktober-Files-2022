public class Dijkstra {
    // Method to compute the vertex with the distance value, which is minimum from the group of vertices that has not been included yet
    ...
    // Method to display the built distance array
    ...
    void dijkstra(int graph[][], int s) {
        ...
        for (int cnt = 0; cnt < totalVertex - 1; cnt++) {
            ...
            // not yet processed. ux is always equal to source s in the first iteration.
